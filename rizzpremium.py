...
# Thanks To God Allah SWT dan semua teman yang membantu
		...
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				if "indonesia" in ips:
					...
					results.append("lampung")
					results.append("ganteng")
					results.append("gantengku")
					results.append("katasandi")
					results.append("qwerty")
					results.append("jomblo")
					results.append("jenong")
					results.append("persija")
					results.append("bokepp")
